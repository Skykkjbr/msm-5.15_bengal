...
# Repo URL
ANYKERNEL_REPO="https://github.com/Skykkjbr/Anykernel3.git"
ANYKERNEL_BRANCH="sapphire"

# Costumize
KERNEL="minimalkernel"
RELEASE_VERSION="obanai"
DEVICE="topaz-xun-sapphiren"
...
# Telegram
CHATIDQ="-1002807833590"
CHATID="-1002807833590" # Group/channel chatid (use rose/userbot to get it)
TELEGRAM_TOKEN="8499982763:AAFTVFpAxqXbkQDRV9wJzB6Ps93tIvrGagY" # Get from botfather

# Export Telegram.sh
TELEGRAM_DIR="${HOME}"/kernel/telegram
if ! [ -d "${TELEGRAM_DIR}" ]; then
    git clone https://github.com/Skykkjbr/telegram.sh/ "${TELEGRAM_DIR}"
fi
